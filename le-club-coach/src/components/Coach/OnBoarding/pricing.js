import '@/pages/Stripe/style.scss'
...
export default class Pricing extends PureComponent {
  ...
  handlePricingSelect = (tier) => {
    return () => {
      this.props.onSelect && this.props.onSelect(tier)
    }
  }
            ...
            <div className={'offer_container'}>
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1, alignItems: 'center', padding: '24px' }}>
                ...
                <div style={{ marginTop: 'auto', width: '100%', fontSize: '12px' }}>
                  ...
                  <Button type='primary' className={'pricing-button'} onClick={this.handlePricingSelect('basic')}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1, alignItems: 'center', padding: '24px' }}>
                ...
                <div style={{ marginTop: 'auto', width: '100%', fontSize: '12px' }}>
                  ...
                  <Button type='primary' className={'pricing-button'} onClick={this.handlePricingSelect('premium')}>
            ...
            <div className={'offer_container'}>
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1, alignItems: 'center', padding: '24px' }}>
                ...
                <div style={{ marginTop: 'auto', width: '100%', fontSize: '12px' }}>
                  ...
                  <Button type='primary' className={'pricing-button'} onClick={this.handlePricingSelect('coach')}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', flex: 1, alignItems: 'center', padding: '24px' }}>
                ...
                <div style={{ marginTop: 'auto', width: '100%', fontSize: '12px' }}>
                  ...
                  <Button type='primary' className={'pricing-button'} onClick={this.handlePricingSelect('club')}>
